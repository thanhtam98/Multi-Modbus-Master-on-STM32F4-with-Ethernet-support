...
#define CR95HF_SPI_SCK_GPIO_CLK    	RCC_AHB1Periph_GPIOB
 
#define CR95HF_SPI_MISO_PIN        	GPIO_Pin_4
#define CR95HF_SPI_MISO_GPIO_PORT  	GPIOB
#define CR95HF_SPI_MISO_GPIO_CLK   	RCC_AHB1Periph_GPIOB
 
#define CR95HF_SPI_MOSI_PIN        	GPIO_Pin_5
#define CR95HF_SPI_MOSI_GPIO_PORT  	GPIOB
#define CR95HF_SPI_MOSI_GPIO_CLK   	RCC_AHB1Periph_GPIOB

#define CR95HF_NCS_PIN             	GPIO_Pin_15
#define CR95HF_NCS_GPIO_PORT       	GPIOA
#define CR95HF_NCS_GPIO_CLK        	RCC_AHB1Periph_GPIOA



//#define CR95HF_NCS_PIN             GPIO_Pin_9                  
//#define CR95HF_NCS_GPIO_PORT       GPIOC                       
//#define CR95HF_NCS_GPIO_CLK        RCC_APB2Periph_GPIOC 

/** 
  * @brief  CR95HF UART Interface pins 
  */ 
// version 2.0.0 use UART2
#define CR95HF_UART			        		USART2
#define CR95HF_UART_CLK		        	RCC_APB1Periph_USART2

#define CR95HF_UART_TX_PIN         	GPIO_Pin_5
#define CR95HF_UART_TX_GPIO_PORT   	GPIOD                       
#define CR95HF_UART_TX_GPIO_CLK    	RCC_AHB1Periph_GPIOD
 
#define CR95HF_UART_RX_PIN        	GPIO_Pin_6                
#define CR95HF_UART_RX_GPIO_PORT  	GPIOD                       
#define CR95HF_UART_RX_GPIO_CLK   	RCC_AHB1Periph_GPIOD

#define CR95HF_IRQin_PIN        		GPIO_Pin_5                 
#define CR95HF_IRQin_GPIO_PORT  		GPIOD                       
#define CR95HF_IRQin_GPIO_CLK   		RCC_AHB1Periph_GPIOD

/* for version 1.x use UART3
#define CR95HF_UART			        		USART3
#define CR95HF_UART_CLK		        	RCC_APB1Periph_USART3

#define CR95HF_UART_TX_PIN         	GPIO_Pin_8
#define CR95HF_UART_TX_GPIO_PORT   	GPIOD                       
#define CR95HF_UART_TX_GPIO_CLK    	RCC_AHB1Periph_GPIOD
 
#define CR95HF_UART_RX_PIN        	GPIO_Pin_9                
#define CR95HF_UART_RX_GPIO_PORT  	GPIOD                       
#define CR95HF_UART_RX_GPIO_CLK   	RCC_AHB1Periph_GPIOD

#define CR95HF_IRQin_PIN        		GPIO_Pin_8                 
#define CR95HF_IRQin_GPIO_PORT  		GPIOD                       
#define CR95HF_IRQin_GPIO_CLK   		RCC_AHB1Periph_GPIOD
...
//	ISO15693ConfigStruct 	ISO15693Config;
//}ReaderConfigStruct;
