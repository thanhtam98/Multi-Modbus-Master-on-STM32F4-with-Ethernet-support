...
static void TM_I2C1_INT_InitPins(TM_I2C_PinsPack_t pinspack) {
	...
	if (pinspack == TM_I2C_PinsPack_1) {
		GPIO_PinAFConfig(GPIOB, GPIO_Pin_6 | GPIO_Pin_7, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_2) {
		GPIO_PinAFConfig(GPIOB, GPIO_Pin_8 | GPIO_Pin_9, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_3) {
		GPIO_PinAFConfig(GPIOB, GPIO_Pin_6 | GPIO_Pin_9, GPIO_AF_I2C1);
	}
#endif
...
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_1) {
		GPIO_PinAFConfig(GPIOB, GPIO_Pin_10 | GPIO_Pin_11, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOF)
	if (pinspack == TM_I2C_PinsPack_2) {
		GPIO_PinAFConfig(GPIOF, GPIO_Pin_0 | GPIO_Pin_1, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOH)
	if (pinspack == TM_I2C_PinsPack_3) {
		GPIO_PinAFConfig(GPIOH, GPIO_Pin_4 | GPIO_Pin_5, GPIO_AF_I2C2);
	}
#endif
	if (pinspack == TM_I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
...
#if defined(GPIOH)
	if (pinspack == TM_I2C_PinsPack_2) {
		GPIO_PinAFConfig(GPIOH, GPIO_Pin_7 | GPIO_Pin_8, GPIO_AF_I2C3);
	}
#endif
	if (pinspack == TM_I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
