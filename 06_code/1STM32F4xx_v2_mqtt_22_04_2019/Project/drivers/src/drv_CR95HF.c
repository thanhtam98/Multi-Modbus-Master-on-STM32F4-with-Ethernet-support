...
{	
	//Enable GPIO clock
	RCC_AHB1PeriphClockCmd(CR95HF_UART_TX_GPIO_CLK | CR95HF_UART_RX_GPIO_CLK|CR95HF_NCS_GPIO_CLK,ENABLE);
	//enable USART 2 clock
	RCC_APB1PeriphClockCmd(CR95HF_UART_CLK , ENABLE);
...
//	delay_ms(2);
	...
	GPIO_PinAFConfig(CR95HF_UART_RX_GPIO_PORT, GPIO_PinSource, GPIO_AF_USART2);
	...
	GPIO_PinAFConfig(CR95HF_UART_TX_GPIO_PORT, GPIO_PinSource, GPIO_AF_USART2);
}
