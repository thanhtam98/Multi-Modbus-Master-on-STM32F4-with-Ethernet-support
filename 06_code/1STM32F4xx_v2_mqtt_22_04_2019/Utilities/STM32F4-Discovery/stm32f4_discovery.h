...
#define TIMER_LED1_BASE							TIM1
#define TIMER_LED1_CLK							RCC_APB2Periph_TIM1

#define TIMER_LED2_BASE							TIM8
#define TIMER_LED2_CLK							RCC_APB2Periph_TIM8

#define TIMER_LED3_BASE							TIM4
#define TIMER_LED3_CLK							RCC_APB1Periph_TIM4


#define LED0_PIN                    GPIO_Pin_11
#define LED0_GPIO_PORT              GPIOD
#define LED0_GPIO_CLK               RCC_AHB1Periph_GPIOD
...
#define OUTPUT_CTL_GPIO_PORT				GPIOE
#define OUTPUT_CTL_GPIO_CLK					RCC_AHB1Periph_GPIOE
#define OUTPUT_CTL_PIN							GPIO_Pin_2
...
#define USER_BUTTON_EXTI_LINE          EXTI_Line5
#define USER_BUTTON_EXTI_PORT_SOURCE   EXTI_PortSourceGPIOB
#define USER_BUTTON_EXTI_PIN_SOURCE    EXTI_PinSource5
