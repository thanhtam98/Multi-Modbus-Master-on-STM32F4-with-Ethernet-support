...
typedef struct 
{
	  sFONT 	CurrentFonts; 		// the fonts being use
	  uint8_t 	CurrentLine,		// last line used
				NbLineMax,			// maximum number of line ( depend on fonts)
				NbCarMax;			// maximum num of cararcterers of one line
uint16_t		LCDHeight,
				LCDWidth;
			
} LCD_DisplayConfigStruct;   
...
/** 240*320 pixel on the screen (76800) */
#define MAX_PIXEL_NUM				76800
/** Dummy byte */
...
#define LCD_NCS_GPIO_CLK     	   	RCC_AHBPeriph_GPIOB 
