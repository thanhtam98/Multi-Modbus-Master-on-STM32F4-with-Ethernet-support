...
WebString.wan_service_alert="WAN connection should  bind to at lease one service!";
...
WebString.wan_pppoe_null_alert="Pppoe username and password should not be NULL!";
WebString.wan_pppoe_alert="Please set correct pppoe username and password!";
WebString.wan_pppoe_alive_alert="Please set correct pppoe keeping alive time(5~60 seconds)!";
...
WebString.wan_service_con_alert="When the service type of wan connnection is TR-069 or VoIP,the connection mode should not be bridge.";
WebString.wan_service_check_alert="ONT will reject to create 2 WAN with the same service type!";	
...
WebString.wan_LAN1_bind_alert="LAN1 is already binding to another wan,LAN1 can not bind to this wan";
WebString.wan_LAN2_bind_alert="LAN2 is already binding to another wan,LAN2 can not bind to this wan";
WebString.wan_LAN3_bind_alert="LAN3 is already binding to another wan,LAN3 can not bind to this wan";
WebString.wan_LAN4_bind_alert="LAN4 is already binding to another wan,LAN4 can not bind to this wan";
WebString.wan_SSID1_bind_alert="SSID1 is already binding to another wan,SSID1 can not bind to this wan";
WebString.wan_SSID2_bind_alert="SSID2 is already binding to another wan,SSID2 can not bind to this wan";
WebString.wan_SSID3_bind_alert="SSID3 is already binding to another wan,SSID3 can not bind to this wan";
WebString.wan_SSID4_bind_alert="SSID4 is already binding to another wan,SSID4 can not bind to this wan";

WebString.init_confirm="Do you want to reset system configuration to factory default setting?";
...
WebString.backup_import_alert="Are you sure to restore configuration file to ONT?";
WebString.backup_export_alert="Are you sure to backup configuration file from ONT?";
...
WebString.ipfilterconfirm = "To change the current mode will lead to empty the previous rules!";
...
WebString.lan_ra_min_err="The minimum period should be 3 to 0.75 times the maximum value between!";

WebString.route_rule_err = "Destination IP address and destination netmask conflict!";
WebString.macfilter_rule_change = "Are you sure to change the policy? Continue will empty the current rules!";
...
WebString.bind_ip_subnet_alert="The bind ip address and lan ip address should be in the same subnet!";
...
XupgradeString[3]="System is writing firmware to flash now, please don't power off or reboot device!";
XupgradeString[4]="Device will reboot in";
XupgradeString[5]="120";
XupgradeString[6]="seconds.";
XupgradeString[7]="Warning: uploaded file is not a valid firmware image file, or upload error!";
...
XslidString[7]="HEX Mode: max to 20 HEX numbers, 0~9/A~F/a~f, e.g: 0x1234567890ABCDEF1234";
...
Xip_filterString[13]="Source IP address and dst ip address can't be empty at the same time!";
...
XdscpString[16]="Since you selected destination netmask, please input destination ip address";
...
XdscpString[20]="DSCP order should not be the same with other dscp remark rules, please select a different order!";
...
XwifiString[0]="The encrypt mode is not the wpa/wpa2 personal, you can't enable wps!";
...
WebString.dmz_alg_wan_alert="There is no wan connection list, please create internet wan connection first.";
...
var ponSta_list=new Array("","Initial State","Standby State","Serial Number State","Ranging State","Operation State","POPUP State","Emergency Stop State");
...
XponinfoString[0] = "Laser Bias Current(ONT ANI-ONT-Side Optical Measurements):";
XponinfoString[1] = "Optics Module Vlotage(ONT ANI-ONT-Side Optical Measurements):";
XponinfoString[2] = "Optics Module Temperature(ONT ANI-ONT-Side Optical Measurements):";
XponinfoString[3] = "Rx Optics Signal Level at 1490 nm(ONT ANI-ONT-Side Optical Measurements):";
XponinfoString[4] = "Tx Optics Signal Level at 1310 nm(ONT ANI-ONT-Side Optical Measurements):";
XponinfoString[5] = " Lower(ONT ANI-ONT-Side Optical Measurements-Optical Threshold):";
XponinfoString[6] = "Upper(ONT ANI-ONT-Side Optical Measurements-Optical Threshold):";
...
WebString.dns_suffix_wan_alert="There is no routed wan existed, no rule can be added";
