...
//#define ENTER_CRITICAL_SECTION( )   vRS485PortEnterCritical()
//#define EXIT_CRITICAL_SECTION( )    vRS485PortExitCritical()
...
#define PORT_HAS_CLOSE	                    1
#define ASCII_TIMEOUT_WAIT_BEFORE_SEND_MS   2
/* Port define -----------------------------------------------------------*/
#define RS485_PORT_NUMBER	4
typedef enum
{
  PORT1 = 0x00,
	PORT2,
